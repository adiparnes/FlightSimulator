...
public class CoditionBulider {
    public static double calcc(String expression){
        ...
        if(i>0||j>0) {
            ...
            num1 = new Number(ShuntinYardPre.calc(deli.substring(0, i)));
        ...
        return ShuntinYardPre.calc(expression);
    }
    ...
    public static double calc(String expression){
        ...
        while(expression.contains("&")||expression.contains("|")){
            ...
            if((j<i&&j!=-1)||i==-1)
                i=j;
            token=ShuntinYardPre.calc(expression.substring(0, i))+"";
        ...
        token=ShuntinYardPre.calc(expression)+"";
        queue.addFirst(token);
        while (!stack.isEmpty())
            queue.addFirst(stack.pop());
